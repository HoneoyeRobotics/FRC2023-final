...
public class Arms extends SubsystemBase {
  ...
  public Arms() {
    ...
    armLengthBrakeSolenoid = new DoubleSolenoid(Constants.CanIDs.PCM, PneumaticsModuleType.CTREPCM,
        Constants.PCMIDs.Arm_Length_Brake_On, Constants.PCMIDs.Arm_Length_Brake_Off);
    clawSolenoid = new DoubleSolenoid(Constants.CanIDs.PCM, PneumaticsModuleType.CTREPCM, Constants.PCMIDs.Claw_Forward,
        Constants.PCMIDs.Claw_Reverse);
  ...
  public boolean isArmRotateAtPosition() {
    ...
    // SmartDashboard.putBoolean("ArmRotateAtSetpoint",
    // armRotatePIDController.atSetpoint());
